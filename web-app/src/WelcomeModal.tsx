    ...
    <Modal {...rest} className={classNames('welcome__modal', className)}>
      <div className="welcome__modal__left">
        ...
        <ul>
          ...
          <li>
            The first 50 appointments is free and each additional for only $0.05
          </li>
        </ul>
      </div>
      <div className="welcome__modal__right">
        ...
        <Button className="btn__facebook">Login with Facebook</Button>
        <div style={{ display: 'none' }}>
          After login a new admin account will be created and assigned to your
          facebook account. You will use this account for registering your staff
          members and to manage your appointment calendar.
        </div>
