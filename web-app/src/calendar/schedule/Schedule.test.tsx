...
it.each`
  date                     | row  | column
  ${'2018-10-29T08:00:00'} | ${1} | ${2}
  ${'2018-10-29T08:30:00'} | ${2} | ${2}
  ${'2018-10-29T08:31:00'} | ${2} | ${2}
  ${'2018-10-29T08:59:00'} | ${2} | ${2}
  ${'2018-10-29T09:00:00'} | ${3} | ${2}
  ${'2018-10-30T08:00:00'} | ${1} | ${3}
  ${'2018-11-01T08:00:00'} | ${1} | ${5}
