...
it.each`
  ...
  ${"2018-10-29T08:00:00"} | ${30}    | ${1} | ${2}   | ${1}
  ${"2018-10-29T08:30:00"} | ${60}    | ${2} | ${2}   | ${2}
  ${"2018-10-29T08:31:00"} | ${90}    | ${2} | ${2}   | ${3}
  ${"2018-10-29T08:59:00"} | ${30}    | ${2} | ${2}   | ${1}
  ${"2018-10-29T09:00:00"} | ${30}    | ${3} | ${2}   | ${1}
  ${"2018-10-30T08:00:00"} | ${30}    | ${1} | ${3}   | ${1}
  ${"2018-11-02T11:00:00"} | ${30}    | ${7} | ${6}   | ${1}
  ${"2018-11-01T08:00:00"} | ${30}    | ${1} | ${5}   | ${1}
  ${"2018-11-11T08:00:00"} | ${30}    | ${1} | ${8}   | ${1}
`(
